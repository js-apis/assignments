  ...
  */
  this.render = function() {
    ...
    */
    ...
    /*
      `characterEl.classList.add('my-class-name')` is a way for us to add a className to an element.
    ...
    */
    ...
    characterEl.append(birth_yearEl);
